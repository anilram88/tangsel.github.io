<div style="text-align: center">
	...
	To change this, Upload your files using ftp (such as a program-filezilla or <a target=_blank href='http://{webserverip}/ehcp/net2ftp/'>webftp</a>)<br>
	(ip:{webserverip})</p>
	Your local ip: {localip}<br>
</div>
